...
const FoodBankManagementPage: React.FC = () => {
  ...
  const loadReferenceData = async () => {
    try {
      ...
      toast.error(
        error.response?.data?.message || "Không tải được dữ liệu kho thực phẩm."
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error("Calo phải là một số hợp lệ.");
      return;
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className="text-base font-semibold text-gray-700"
                >
                  Calo (trên 100g) <span className="text-red-500">*</span>
                </Label>
                <Input
                  id="calories"
                  type="number"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Nhập mức Natri"
                  className="bg-white border-gray-300 text-lg focus:border-blue-400 focus:ring-0"
                />
              </div>
              <div className="space-y-2">
                <Label className="text-base font-semibold text-gray-700 block mb-3">
                  Chất gây dị ứng / Nhãn dinh dưỡng
                </Label>
                <div className="flex flex-wrap gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200 min-h-[60px]">
                  ...
                  {allergenTags.length === 0 && (
                    <span className="text-sm text-gray-500 italic">
                      Không có dữ liệu dị ứng từ cư dân / món ăn.
                    </span>
                  )}
                </div>
              </div>
              ...
              {ingredients.length === 0 && (
                <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Lưu ý:</strong> Không có nguyên liệu nào. Vui lòng
                    yêu cầu quản trị viên nhập/tạo nguyên liệu trước.
                  </p>
                </div>
              )}
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-lg text-gray-500">
                Không có món ăn nào trong kho thực phẩm.
              </p>
            </div>
          ) : (
