...
const ScheduleActivitiesManagementPage: React.FC = () => {
  ...
  const filteredActivities = useMemo(() => {
    return activities.filter((activity) => {
      ...
      const matchesStaff =
        !staffFilter || activity.assignedStaff === staffFilter;
      return (
        matchesSearch &&
        matchesDate &&
        matchesRoom &&
  ...
  const validateForm = () => {
    ...
    if (!formData.assignedStaff.trim())
      errors.assignedStaff = "Assigned staff is required";
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  {formErrors.room && (
                    <p className="text-red-500 text-sm">{formErrors.room}</p>
                  )}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
