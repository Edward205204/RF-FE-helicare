...
interface ResidentHealthSummaryProps {
  residentId?: string;
}

export const ResidentHealthSummary: React.FC<ResidentHealthSummaryProps> = ({
  residentId,
}) => {
        ...
        {summary.indicators.map((indicator) => (
          ...
          >
            ...
            <CardContent className="pt-0">
              ...
              <Badge
                variant="outline"
                className={`mt-3 border ${severityColors[indicator.severity]}`}
              >
